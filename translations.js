...
export const UI_TRANSLATIONS = {
  cs: {
    ...
    booking: {
      ...
      summary: {
        resumeLead: 'Pokračujeme v rezervaci, kterou jste začali.',
        sessionLabel: 'Termín',
        sessionsLabel: 'Termíny',
        paymentLabel: 'Platba',
        workshopBundle: 'Všechna setkání workshopu ({{n}})',
      },
      btn: {
        ...
        changeSelection: 'Změnit termín nebo platbu',
        booking: 'Rezervuji…',
        buying: 'Kupuji…',
        book: 'Rezervovat',
    ...
    courses: {
      ...
      freeCancellation: 'Možnost storna (v případě vstupu na permanentku):',
      freeCancellationShort: 'Možnost storna',
      ahead: 'předem',
      scheduledDates: 'Vypsané termíny',
      bookingSectionTitle: 'Rezervace',
      detailLoginToBook: 'Pro výběr platby a dokončení rezervace se přihlaste nebo zaregistrujte.',
      guestFinishAfterLogin: 'Po přihlášení dokončíte rezervaci jedním kliknutím.',
      guestPriceEntry: 'Cena za vstup {{price}}',
      guestPriceWorkshop: 'Cena {{price}}',
    ...
    admin: {
      ...
      courseModal: {
        ...
        errCapacity: 'Zadejte kapacitu (min. 1 místo).',
        errMinParticipants: 'Minimální počet účastníků musí být 1–kapacita.',
        errCancellation: 'Vyberte platnou lhůtu pro storno (6, 24 nebo 48 hodin).',
        errTimeRange: 'Zadejte čas od a čas do.',
        errTimeOrder: 'Čas do musí být po čase od.',
  ...
  en: {
    ...
    booking: {
      ...
      summary: {
        resumeLead: 'Continuing the booking you started.',
        sessionLabel: 'Session',
        sessionsLabel: 'Sessions',
        paymentLabel: 'Payment',
        workshopBundle: 'All workshop sessions ({{n}})',
      },
      btn: {
        confirmBooking: 'Confirm booking',
        confirmAndPay: 'Confirm and pay {{price}}',
        buyPassAndBook: 'Buy a pass & book my first session · {{price}}',
        cancel: 'Cancel',
        buyPass: 'Buy a pass',
        buyPassAndReserve: 'Buy a pass & book',
        continueToBooking: 'Continue to booking',
        changeSelection: 'Change session or payment',
        booking: 'Booking…',
        buying: 'Buying…',
        book: 'Book',
    ...
    courses: {
      ...
      freeCancellation: 'Cancellation option (when using a pass entry):',
      freeCancellationShort: 'Cancellation option',
      ahead: 'in advance',
      scheduledDates: 'Scheduled dates',
      bookingSectionTitle: 'Booking',
      detailLoginToBook: 'Sign in or register to choose payment and complete your booking.',
      guestFinishAfterLogin: 'After signing in, you can finish your booking in one click.',
      guestPriceEntry: 'Price per entry {{price}}',
      guestPriceWorkshop: 'Price {{price}}',
    ...
    admin: {
      ...
      courseModal: {
        ...
        errCapacity: 'Enter capacity (at least one place).',
        errMinParticipants: 'Minimum participants must be between 1 and capacity.',
        errCancellation: 'Please select a valid cancellation window (6, 24 or 48 hours).',
        errTimeRange: 'Enter start and end time.',
        errTimeOrder: 'End time must be after start time.',
