    ...
    ">
      ...
      <div id="gdpr-step-1">
        <div style="padding:20px 20px 0;">
          ...
          <div style="font-size:16px;font-weight:500;color:#1a1a1a;margin-bottom:6px;">
            ${t('Smazat účet', 'Delete account')}
          </div>
          <div style="font-size:13px;color:#6b6b6b;line-height:1.6;margin-bottom:14px;">
            ${t(
          ...
          <div style="margin-bottom:16px;">
            <label style="font-size:12px;color:#6b6b6b;display:block;margin-bottom:4px;">
      ...
      <div id="gdpr-step-2" style="display:none;">
        <div style="padding:20px 20px 0;">
          <div style="font-size:16px;font-weight:500;color:#791F1F;margin-bottom:8px;">
          ...
          <label style="
            ...
            font-size:13px;color:#1a1a1a;margin-bottom:16px;cursor:pointer;
          ">
        ...
        <div style="padding:0 20px 18px;display:grid;grid-template-columns:1fr 1fr;gap:8px;">
          <button onclick="gdprStep1()" style="
            padding:10px;border-radius:8px;
            border:0.5px solid rgba(0,0,0,0.18);
            background:transparent;color:#1a1a1a;font-size:13px;cursor:pointer;
          ">
            ← ${t('Zpět', 'Back')}
          </button>
      ...
      <div id="gdpr-step-3" style="display:none;padding:32px 20px;text-align:center;">
        ...
        <div id="gdpr-progress-title" style="
          font-size:15px;font-weight:500;color:#1a1a1a;margin-bottom:6px;
        ">
          ${t('Mažu účet…', 'Deleting account…')}
        </div>
        <div id="gdpr-progress-sub" style="font-size:13px;color:#6b6b6b;">
...
export function injectDeleteButton(lang = 'cs') {
  ...
  section.innerHTML = `
    ...
    <button id="gdpr-open-btn" style="
      ...
      color:#791F1F;font-size:13px;font-weight:500;
      cursor:pointer;text-align:left;
    ">
      ${t('Smazat můj účet', 'Delete my account')}
    </button>
    <div style="font-size:11px;color:#9b9b9b;margin-top:6px;line-height:1.5;">
      ${t(
